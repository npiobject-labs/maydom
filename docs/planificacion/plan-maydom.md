...
### Compra
Lista unificada: lo que baja del umbral en Alimentación y Suplementos más lo que se añade a mano. Cada línea con tienda preferida. Marcar comprado repone stock. Comprar de verdad —varios productos repartidos entre varias tiendas— pide un eje que hoy no existe (*una tienda → muchos productos*, frente al *un producto → muchas tiendas* del Buscador): las posibilidades, con fases y lo descartado, en [`compra-multitienda.md`](compra-multitienda.md).
...
| D16 | **Comprar varios productos en varias tiendas** | La lista agrupa por tienda pero no hay forma de recorrer una tienda entera, ni de devolver a la lista lo que encuentras en el Buscador | Fases C1–C4 de [`compra-multitienda.md`](compra-multitienda.md): recorrido «comprar en esta tienda» y «+ a la compra» desde el Buscador (sin LLM, ~3 h), después tienda aprendida por producto y plantillas de compra, y dictar la lista entera al final. El carrito automático y las cuentas de tienda quedan descartados por ADR-006 |
