...
respuesta = { descripcion: 'Ingredientes: 80 g de arroz integral, 100 g de tofu.\nPreparación: cocer y saltear.\nPor ración: 450 kcal.\nNota:', etiquetas: ['vegetal'], momentos: ['comida'], min: 35 };
...
comprobar((await campo('descripcion')).startsWith('Ingredientes: 80 g'), 'descripción escrita');
